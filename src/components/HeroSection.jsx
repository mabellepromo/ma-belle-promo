...
/* ══ BULLE D'EAU — version animée desktop ══ */
...
const SECTION_STYLE = {
  background: "linear-gradient(150deg, var(--brand-dark) 0%, var(--brand-dark-light) 40%, var(--brand-dark-mid) 70%, hsl(150,28%,6%) 100%)",
};
...
/* ══ VERSION MOBILE — HTML pur, zéro Framer Motion ══ */
function HeroSectionMobile({ sectionRef }) {
  return (
    <section
      ref={sectionRef}
      id="hero"
    ...
    >
      ...
      {/* Contenu */}
      <div className="relative z-10 flex-1 flex flex-col px-6 pt-28 pb-16 max-w-7xl mx-auto w-full">

        {/* Bandeau identification */}
        <div className="flex items-center gap-3 mb-8 w-full" style={{ marginTop: "0.5cm" }}>
          <p className="text-center min-w-0 w-full" style={{
        ...
        <div className="flex-1 flex items-center">
          <div className="w-full grid gap-8 items-center">
            ...
            {/* Col 2 : Titre + citation + CTAs */}
            <div>
              <h1
                className="font-heading leading-none mb-6 text-center"
                style={{ fontSize: "clamp(1.1rem, 2.8vw, 2rem)", fontWeight: 900, letterSpacing: "-0.03em" }}
              >
                <span className="block mb-1" style={{ color: "rgba(255,255,255,0.95)" }}>
              ...
              <div className="relative mb-8 pl-5" style={{ borderLeft: "2px solid rgba(52,211,153,0.45)" }}>
                <span className="block text-4xl font-serif leading-none mb-2" style={{ color: "#6ee7b7", opacity: 0.6 }}>"</span>
                <blockquote className="font-heading text-lg leading-relaxed font-semibold mb-4"
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link
                  ...
                  className="flex items-center gap-2 justify-center font-bold text-base rounded-full"
                  style={{
                    padding: "14px 28px",
...
export default function HeroSection() {
  ...
  if (isMobile) {
    return <HeroSectionMobile sectionRef={ref} />;
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Grille responsive ── */}
        <div className="flex-1 flex items-center">
        <div className="w-full grid md:grid-cols-[auto_1fr] lg:grid-cols-[auto_1fr_340px] gap-8 md:gap-10 lg:gap-14 items-center">
          ...
          {/* ── COL 3 : Photo présidente — desktop only ── */}
          <motion.div
