...
export function useEvenements() {
  ...
  async function add(item) {
    ...
    try {
      ...
      else { toast.success("Événement ajouté !"); await load(); }
    } finally {
      setSaving(false);
    }
  }
  ...
  async function update(id, item) {
    ...
    try {
      ...
      else { toast.success("Événement mis à jour !"); await load(); }
    } finally {
      setSaving(false);
    }
  }
  ...
  async function remove(id) {
    ...
    try {
      ...
      else { toast.success("Événement supprimé."); await load(); }
    } finally {
      setSaving(false);
    }
  }
  ...
  async function seedFromStatic() {
    ...
    try {
      ...
      else { toast.success(`${evenementsStatic.length} événements migrés !`); await load(); }
    } finally {
      setSaving(false);
    }
  }
