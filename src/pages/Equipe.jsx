      ...
      <section className="relative py-20 max-w-6xl mx-auto px-6">
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {equipe.map((membre, i) => (
            ...
            >
              <TiltCard className="group bg-card border border-border rounded-2xl overflow-hidden hover:shadow-xl hover:border-primary/30 transition-all duration-300 h-full">
